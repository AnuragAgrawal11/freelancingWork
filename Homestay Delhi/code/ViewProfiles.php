...
<body>
	<div id="header">
	  ...
	  <ul id="navBar">
			...
			<li class="current"><a href="ViewProfiles.php">Search Homestay</a></li>
        	...
        	<div id="container" class="clearfix">
            	<div id="mainCol" class="clearfix">
            	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="644" height="194">
					...
					<br/><br/><br/>
					<img src="images/image2.jpg" width="200px" height="200px" border="1">
					
					<img src="images/image3.jpg" width="200px" height="200px" border="1">
					<img src="images/image4.jpg" width="200px" height="200px" border="1">
					
					<p><font color="#663300" size="3">Search your homestay from 28 diversified states and more than 150 cities of the great ancient historic country India.
					
					</p>
					<p><font color="#FF9900">Experience the Indian Hospitality :</font><br/>
					<font color="#0033ff">
					 * Feel The Comfort<br/>
					 * Feel The Affection<br/>
					* Experience The Hospitality<br/>
					* Comfort Of Homestay<br/>
					</font>
					</font>
					</p> 
