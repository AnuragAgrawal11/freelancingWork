...
include "connect.php";
$query="SELECT * FROM images WHERE user_name='".$name."'";
$result=mysql_query($query);;
?>
    	...
    	<div id="secWrapper">
       	<div id="container" class="clearfix">
            	  ...
            	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="644" height="194">
                    ...
                    <h3 id="why"><?php echo $name;?> Gallery </h3>
					...
					<?php if($name==$_SESSION['user']&& $row[14]=="member")
					{?>
					<form action="upload_file_gallery.php" method="post"
					...
					<?php $var=0;
						  ...
						  { $var++;?>
						  <img style="margin-left:10px; margin-bottom:5px; border:solid; border-color:#000000;" 
						  src="<?php echo "uploaded/".$name."/".$rowG[0]; 
						  ?>" width="250px" height="250px"/>
						  <?php if($name==$_SESSION['user'])
					{?>
					<?php echo '<a href="delete_image.php?name='.$rowG[0].'" >Delete</a>'; ?>
