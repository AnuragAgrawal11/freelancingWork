...
{
include "connect.php";
$query="SELECT * FROM personal WHERE user_name='".$_REQUEST['owner']."'";
        	...
        	<div id="container" class="clearfix">
            	<div id="mainCol" class="clearfix">
            	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="644" height="194">
                    ...
                    <h3 id="why"><?php echo $_REQUEST['owner']; ?> Account </h3>
					<p><a href="scrapbook.php?owner=<?php echo $_REQUEST['owner'];?>"><img src="images/scrapbook.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gallery.php?owner=<?php echo $_REQUEST['owner'];?>"><img src="images/gallery.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					
					
					<?php
					if($_SESSION['level']=="Client")
					{?>
					<a href="bookstay.php?mailto=<?php echo $row[6];?>"><font size="2.5">Book this homestay</font></a>
                    ...
                    <li class="clearfix last">
                      <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px">
                        <tr bgcolor="#CCFFCC">
                          <th width="30%" scope="row"><img style="margin-left:10px; margin-bottom:5px; border:solid; border-color:#000000;" src="<?php echo "uploaded/".$_REQUEST['owner'].$row[2]; ?>" width="300px" height="300px"/> </th>
                          <td width="70%"><font size="4" color="#FF9900">&nbsp;&nbsp;&nbsp;&nbsp;Name :</font><font size="4"><?php echo $_REQUEST['owner']; ?></font><br/>
...
include "connect.php";
$query="SELECT * FROM profile WHERE user_name='".$_REQUEST['owner']."'";
$result=mysql_query($query);
$row=mysql_fetch_row($result);
?>

				<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Accomodation Type :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[0]; ?></font></td>
                        </tr>		
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Maximum Person :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[1]; ?></font></td>
                        </tr>		
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Price :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[2]; ?></font></td>
                        </tr>		
						
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Price Type :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[3]; ?></font></td>
                        </tr>		
						
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Food :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[4]; ?></font></td>
                        </tr>		
						
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Food Type :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[5]; ?></font></td>
                        </tr>		
						
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Description :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[6]; ?></font></td>
                        </tr>		
						
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Occupation :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[7]; ?></font></td>
                        </tr>		
						<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Qualification :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[8]; ?></font></td>
                        </tr>		<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Languages Known :</font></td>
                           <td><font size="3" style="margin-left:10px;"><?php echo $row[9]; ?></font></td>
                        </tr>		<tr>
                          <td scope="row"><font size="3" color="#FF9900" style="margin-left:10px;">Message For Clients :</font></td>
