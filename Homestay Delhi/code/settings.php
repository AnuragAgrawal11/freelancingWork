...
/* Website title */
$settings['website_title']="My Home Stay.in";

/* Website URL */
$settings['website_url']='http://www.myhomestay.in/';

/* Guestbook title */
$settings['gbook_title']="Our Guestbook";

/* Your e-mail address. */
$settings['admin_email']='planethelp@gmail.com';
...
$settings['spam_question']='Type <b>IPIX</b> below to show you are not a robot:';

/* Correct answer to the anti-SPAM logical question */
$settings['spam_answer']='IPIX';
