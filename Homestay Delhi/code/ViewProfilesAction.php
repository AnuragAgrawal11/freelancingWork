        	...
        	<div id="container" class="clearfix">
            	<div id="mainCol" class="clearfix">
            	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="644" height="194">
                    ...
                    <h3 id="why">View Profiles</h3>
<?php
include "connect.php";
$query="SELECT user_name FROM profile WHERE accomodation_type='".$_REQUEST['accomodation_type']."' AND state='".$_REQUEST['state']."' AND city='".$_REQUEST['city']."'";
$result0=mysql_query($query);

while($row0=mysql_fetch_row($result0))
{
	$query="SELECT * FROM personal WHERE user_name='".$row0[0]."'";
...
?>
                    ...
                    <li class="clearfix last">
                      <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px">
                        <tr bgcolor="#CCFFCC">
                          <th width="30%" scope="row"><a href="DetailedProfileView.php?owner=<?php echo "$row0[0]"; ?>" target="_blank"><img  style="margin-left:10px;  margin-bottom:5px; border:solid; border-color:#000000;" src="<?php echo "uploaded/".$row['0'].$row[2]; ?>" width="300px" height="300px"/></a> </th>
                          <td width="70%"><font size="4" color="#FF9900">&nbsp;&nbsp;&nbsp;&nbsp;Name :</font><font size="4"><?php echo $row0[0]; ?></font><br/>
