    	...
    	<div id="secWrapper">
        	<div id="container" class="clearfix">
            	<div id="mainCol" class="clearfix">
            	  <h3 id="why"><b>Advertise With Us</b></h3>
                    <ul id="maincon">
                   
                    <p><font size="3">Homestay delivers innovative solutions to build your brand and drive the response you want.</font><br/>
					<font size="3" color="#FF9900">Search</font><br/>
					<font size="3">Drive interested prospects to your site or store with a variety of search marketing & local listing solutions. </font><br/>
					<font size="3" color="#FF9900">Promotions</font><br/>
				    <font size="3">Find unique ways to target your audience, including buzz-worthy brand and direct response promotions. </font></p>
					
					<img src="images/advertise.png" align="center">
					<p><font size="3" color="#FF9900">Display</font><br/>
					<font size="3">Put your message front and center with our innovative ad formats and highly visible placement options for brand and direct response 			                     advertising.</font><br/>
					
					<font size="3" color="#FF9900">Targeting</font><br/>
					<font size="3">Capture your most valuable audience when and where you want to reach them with a broad spectrum of industry-leading targeting                     solutions.</font>
