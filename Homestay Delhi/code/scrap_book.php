        	...
        	<div id="container" class="clearfix">
            	<div id="mainCol" class="clearfix">
            	  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="644" height="194">
                    ...
                    <h3 id="why">My Account </h3>
					<p><a href="#"><img src="images/scrapbook.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gallery.php"><img src="images/gallery.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <ul id="maincon"></li>
                      ...
                      <table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px">
                        ...
                        <tr bgcolor="#CCFFCC">
                          <th width="30%" scope="row"><img style="margin-left:10px; margin-bottom:5px; border:solid; border-color:#000000;" src="<?php echo "uploaded/".$_SESSION['user'].$row[2]; ?>" width="153px" height="117px"/></th>
			  ...
			  if($_SESSION['login']==1)
			  {
				...
				echo "<br/>";
				echo "<a href='MyAccount copy.php'><img src='images/my Account.png' border='0'></a>";
				echo "<br/>";
				echo "<a href='MyAccount copy2.php'><img src='images/my profile.png' border='0'></a>";
			  }
			  else
			  {?>
                    	<h4>Members login</h4>
...
<div id="footer">
<p align="center"><font color="#FF9900" size="4">
  Blogspot &nbsp;<img src="images/blog.png" width="40" height="36" align="absmiddle"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orkut &nbsp;<img src="images/orkut_logo.png" width="40" height="36" align="absmiddle"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Facebook &nbsp;<img src="images/face11.png" width="40" height="36" align="absmiddle"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Twitter &nbsp;<img src="images/twitter1.png" width="40" height="36" align="absmiddle"/></font></p>
    	<ul>
