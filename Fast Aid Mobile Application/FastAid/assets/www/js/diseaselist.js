...
function getEmployees(tx) {
	var sql = "select e.id, e.disease, e.about, e.med1, e.image from medicine AS e WHERE disease LIKE '%"+diseaseName+"%'";
...
function getEmployees_success(tx, results) {
	...
	for (var i=0; i<len; i++) {
		...
		$('#busy').hide();
		$('#employeeList').append('<li><a href="javascript:cal(' + medicine.id + ');">' +
				'<h2>' + medicine.disease + '</h2>');
    }
	}
	setTimeout(function(){
		scroll.refresh();
...
function populateDB(tx) {
    ...
    tx.executeSql("INSERT INTO medicine (id,disease,about,med1,med2,med3,med4,med5,med6,med7,med8,med9,med10,extra,image) VALUES (2, 'Back Pain', 'Back pain affects eight in ten people at some point in their lives â€“ it can be a dull ache or sharp shooting pain any part of the back, and it can be caused by nerve or muscle problems, arthritis, or degenerative disc disease.\n', 'Aspirin', 'Buprenorphine', 'Duloxetine', 'Paracetamol', 'Nimesulide', 'Naproxen', 'Mefenamic Acid', 'Ketoprofen', 'Indomethacin', 'Ibuprofen', '', 'steven_wells.jpg')");
	 ...
	 tx.executeSql("INSERT INTO medicine (id,disease,about,med1,med2,med3,med4,med5,med6,med7,med8,med9,med10,extra,image) VALUES (4, 'Back Pain at Workplace', 'Back pain affects eight in ten people at some point in their lives â€“ it can be a dull ache or sharp shooting pain any part of the back, and it can be caused by nerve or muscle problems, arthritis, or degenerative disc disease.', 'Duloxetine', 'Indomethacin', 'Ketoprofen', 'Nabumetone', 'Tolmetin', '', '', '', '', '', '', 'steven_wells.jpg')");
	 tx.executeSql("INSERT INTO medicine (id,disease,about,med1,med2,med3,med4,med5,med6,med7,med8,med9,med10,extra,image) VALUES (5, 'Back Pain', 'Back pain affects eight in ten people at some point in their lives â€“ it can be a dull ache or sharp shooting pain any part of the back, and it can be caused by nerve or muscle problems, arthritis, or degenerative disc disease.', 'Aspirin', 'Aspirin and Oxycodone', 'Buprenorphine', 'Diclofenac', 'Duloxetine', 'Ibuprofen', 'Indomethacin', 'Ketoprofen', 'Mefenamic Acid', 'Meperidine', 'Nimesulide', 'steven_wells.jpg')");
