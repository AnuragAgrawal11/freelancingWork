...
<li id="navPages" class="nav">
	...
	<div id="content">		
		...
		*/
		...
		$tbl_name="m_area";		//your table name
		...
		*/
		...
		$targetpage = "areaview.php"; 	//your file name  (the name of this file)
	...
	{	
		...
		?>
                	...
                	<tr>
                      <?php 
				   $query1 = "SELECT * FROM m_city WHERE city_id= '".$table[1]."'";
				  // echo $query1;
		$rsd1 = mysql_query($query1);
		$rows1 = mysql_fetch_assoc($rsd1);
		$cname = $rows1['city_name'];
				   
				
				   
				   
				   ?>
                     	<td align="left"><b><?php echo $cname ; ?></b></td>
                       <td><?php echo $table[2] ; ?></td>
                        	<td><?php echo $table[3] ; ?></td>
                            <td><?php echo $table[4] ; ?></td>
                   <td><?php if($table[5]==1){ echo "Active";} else echo "Inactive" ; ?></td>
                 
                   <td><a href="areaup.php?aid=<?php echo $table[0];?>&cid=<?php echo $table[1];?>"><img src="images/silk/pencil.png"></a></td>
                  
                       <td ><a href="delete_area.php?aid=<?php echo $table[0];?>&cid=<?php echo $table[1];?>"><img src="images/silk/cross.png"></a></td>
