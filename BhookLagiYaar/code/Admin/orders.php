...
<li id="navPages" class="nav">
	...
	<div id="content">		
			...
			<div class="grid-16">
            	...
            	<thead>
                	<tr>
                        ...
                        <th><strong>Restuarant</strong></th>
                        <th><strong>Bill</strong></th>
                        <th><strong>TotalPay</strong></th>
		...
		*/
		...
		$targetpage = "orders.php"; 	//your file name  (the name of this file)
	...
	{	
		...
		?>
                ...
                <tbody>
                   ...
                   <td align="left"><b><?php echo $table[0] ; ?></b></td>
          <?php 
				   $query1 = "SELECT * FROM customer WHERE customer_id= '".$table[1]."'";
				  // echo $query1;
		$rsd1 = mysql_query($query1);
		$rows1 = mysql_fetch_assoc($rsd1);
		$cname = $rows1['Username'];
				   
				   
				  $query2 = "SELECT * FROM restaurant WHERE restaurant_id= '".$table[2]."'";
				  // echo $query2;
		...
		$rname = $rows2['name'];  
                   ...
                   <td align="left"><?php echo $cname ; ?></td>
                   <td align="left"><?php echo $rname ; ?></td>
                   <td align="left"><?php echo $table[3] ; ?></td>
                   <td align="left"><?php echo $table[6] ; ?></td>
                   <td align="left"><?php echo $table[8] ; ?></td>
...
<div id="footer">Copyrights © 2013 BhookLagiYaar.com All Right Reserved</div>
