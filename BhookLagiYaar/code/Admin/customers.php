...
<li id="navPages" class="nav">
	...
	<div id="content">		
		...
		<div class="container">
			...
			<div class="grid-16">
				...
				<h1>Welcome Admin</h1>
					...
					<table align="center" style="border:dashed;text-align:left;padding:10px;" class="list-table" width="90%;">
            	<thead>
		...
		*/
		...
		$tbl_name="customer";		//your table name
		...
		*/
		...
		$targetpage = "customers.php"; 	//your file name  (the name of this file)
	...
	{	
		...
		?>
                ...
                <tbody>
                   ...
                   <td align="left"><?php echo $table[4] ; ?></td>
                   <td align="left"><?php echo $table[2] ; ?></td>
                   <td align="left"><?php echo $table[5] ; ?></td>
