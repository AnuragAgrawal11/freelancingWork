...
<li id="navPages" class="nav">
	...
	<div id="content">		
		...
		*/
		...
		$tbl_name="m_city";		//your table name
		...
		*/
		...
		$targetpage = "cityview.php"; 	//your file name  (the name of this file)
	...
	{	
		...
		?>
                   ...
                   <td><a href="cityup.php?cid=<?php echo $table[0];?>"><img src="images/silk/pencil.png"></a></td>
                  
                       <td ><a href="delete_city.php?cid=<?php echo $table[0];?>"><img src="images/silk/cross.png"></a></td>
