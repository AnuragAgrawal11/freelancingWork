...
<li id="navPages" class="nav">
	...
	<div id="content">		
		...
		*/
		...
		$targetpage = "restaurantview.php"; 	//your file name  (the name of this file)
	...
	{	
		...
		?>
                   ...
                   <td><?php echo $table[10] ; ?></td>
               <?php    
                   $query1 = "SELECT area_name FROM m_area WHERE area_id= '".$table['ref_m_area']."'";
				  // echo $query1;
		$rsd1 = mysql_query($query1);
		$rows1 = mysql_fetch_assoc($rsd1);
		
                   ?>
                   <td><?php echo $rows1['area_name'] ; ?></td>
                   
                   
                   <td><?php echo $table['address'] ; ?></td>
                   <td><a href="restaurantup.php?rid=<?php echo $table[0];?>&cid=<?php echo $table['ref_m_city'];?>&aid=<?php echo $table['ref_m_area'];?>"><img src="images/silk/pencil.png"></a></td>
                  
                       <td ><a href="delete_restaurant.php?rid=<?php echo $table[0];?>"><img src="images/silk/cross.png"></a></td>
