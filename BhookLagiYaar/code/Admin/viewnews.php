...
<head>
	...
	<title>Canvas Admin - Form Validation</title>
			...
			<div class="grid-16">
            	...
            	<thead>
                	<tr>
                        ...
                        <th colspan="2" style="text-align:center">Page Actions</th>
                    </tr>
                </thead>
                 <?php 
...
?>
                ...
                <tbody>
                   ...
                   <td><?php echo $table[4] ; ?></td>
                        ...
                        <td><a href="entry_update.php?code=<?php echo $table[0] ;?>">Accept</a></td>
                        <td><a href="entry_delete.php?code=<?php echo $table[0] ;?>">Reject</a></td>
                    </tr>
