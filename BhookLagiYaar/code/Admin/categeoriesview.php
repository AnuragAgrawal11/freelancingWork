...
<li id="navPages" class="nav">
	...
	<div id="content">		
        ...
        <?php } ?>
                ...
                <?php 
					...
					$queryStr = "SELECT * FROM m_menu_category";	
		...
		*/
		...
		$tbl_name="m_menu_category";		//your table name
		...
		*/
		...
		$targetpage = "categeoriesview.php"; 	//your file name  (the name of this file)
	...
	{	
		...
		?>
                   ...
                   <td><?php if($table[3]==1){ echo "Active";} else echo "Inactive" ; ?></td>
                 
                   <td><a href="categeoriesup.php?cid=<?php echo $table[0];?>"><img src="images/silk/pencil.png"></a></td>
