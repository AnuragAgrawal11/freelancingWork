...
<head>
	...
	<title>Orizon - A Powerfull Professional HTML Template Theme</title>
	<link rel="icon" type="image/png" href="http://www.zemotion.co.uk/images/favicon.png"/>
	
	<!-- Style for the SKIN applied -->
	<link rel="stylesheet" type="text/css" href="skins/darkwood/styles.css" media="all" />
	...
	<!--[if IE 7]>
		<link rel="stylesheet" type="text/css" href="http://www.zemotion.co.uk/demo/Orizon/lib/css/ie7.css" media="all" />
	<![endif]-->
	<!--[if IE 8]>
		<link rel="stylesheet" type="text/css" href="http://www.zemotion.co.uk/demo/Orizon/lib/css/ie8.css" media="all" />
	<![endif]-->
...
<body>
	...
	<div id="color_switcher">
		<div id="skins">
			<ul>
				<li>Skins:</li>
				<li><a href="demoskin/blue/index.html" title="Blue" class="blue skin"></a></li>
				<li><a href="demoskin/coffee/index.html" title="Coffee" class="coffee skin"></a></li>
				<li><a href="demoskin/darkwood/index.html" title="Darkwood" class="darkwood skin"></a></li>
				<li><a href="demoskin/green/index.html" title="Green" class="green skin"></a></li>
				<li><a href="demoskin/lightgreen/index.html" title="Lightgreen" class="lightgreen skin"></a></li>
				<li><a href="index-2.html" title="Lightwood" class="lightwood skin"></a></li>
				<li><a href="demoskin/orange/index.html" title="Orange" class="orange skin"></a></li>
				<li><a href="demoskin/pink/index.html" title="Pink" class="pink skin"></a></li>
				<li><a href="demoskin/red/index.html" title="Red" class="red skin"></a></li>
				<li><a href="demoskin/silver/index.html" title="Silver" class="silver skin"></a></li>
				<li><a href="demoskin/yellow/index.html" title="Yellow" class="yellow skin"></a></li>
			</ul>
		</div> <!-- skins -->
		<div id="colors">
			<ul>
		...
		<div id="show" class="vertical_slideshow">
  		...
  		<div class="full_page mb40">
  			<h2>
  				...
  				This is a clean and professional Themeforest template, perfect for a Portfolio as showcasing your work and for any business looking for a pretty 						functional website 
  		...
  		<div id="equalize"> <!-- used to equalize all box at the same height -->
  			<div class="bg_one_third">
  				<h1>Infotsav 10</h1>
  				<p align="justify"><span class="dropcap">T</span>he war song is echoing, and warriors are awaited as the battle ground is set, with thumping hearts. Infotsav10 is back to give you the ultimate taste of technology and management, through its diverse and multifarious events.</p>

  					<p align="justify">Warriors!!! The battle is ripe and is calling upon you.

Sharpen thy weapons, put on thy armor, gird up thy loins and come forth.</p>
	
  						<a href="#" class="more">Read more<span></span></a>
  			</div> <!-- bg_one_third -->
  			<div class="bg_one_third">
  				<img src="pictures/london.jpg" alt="" />
  				<p><span class="dropcap">C</span>hoose between 7 homepage templates with 6 different slideshow, a portfolio page with 2 different views and much more...</p>
  						<a href="#" class="more">Read more<span></span></a>
  			</div> <!-- bg_one_third -->
  			<div class="bg_one_third last">
  				<h1>Last Post</h1>
  				<h3>Design Flexibility</h3>
  				<span class="date_post">13.04.2010</span> <br />
  				<p><span class="dropcap">Y</span>our theme comes with 22 page templates showcasing all the design flexibility this theme has to offer, including Drop Cap, Button Styles and multiple style layouts.</p>
  						<a href="#" class="more">Read more<span></span></a>
  			</div> <!-- bg_one_third last -->
  		</div> <!-- equalize -->
		
		<div id="footer">
			<p>&copy; 2010 <a href="http://www.zemotion.co.uk/">Zemotion</a> - All rights reserved. Conforms to W3C Standard <a href="http://validator.w3.org/check?uri=http%3A%2F%2Fwww.zemotion.co.uk%2Fdemo%2FOrizon%2F">XHTML</a> | 
