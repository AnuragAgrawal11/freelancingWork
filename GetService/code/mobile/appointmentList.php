...
$query = mysql_query("SELECT * FROM appointments Where user_id ='".$_GET["user_id"]."'");
...
while ($row = mysql_fetch_array($query, MYSQL_ASSOC)) {
	...
	$row_array['aap_date'] = $appointment_date1;
	$row_array['aap_time'] = $appointment_time1;
	$row_array['rem_date'] = $reminder_date1;
	$row_array['rem_time'] = $reminder_time1;
